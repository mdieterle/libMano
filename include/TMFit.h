...
protected:
    ...
    Bool_t kEff;                            // boolean for efficiency application
    ...
    Double_t fGauMeanTol;                   // gauss fit mean tolerance
...
public:
    ...
    TMFit() : TNamed(), fc(0), fNBG(0), fNCTbins(0), fNEbins(0),
              ...
              fIM(0), kTwoSig(0), kFitE(0), kExFunc(0), kIntAll(0), kEff(0),
              ...
              fGauMeanMin(0), fGauMeanMax(0), fGauMeanTol(0), 
              fGauSigmaMin(0), fGauSigmaMax(0), 
              fSigma(0), 
    ...
    void ApplyEfficiency(Bool_t k){ kEff = k; }
    ...
    void SetGaussFitMean(Double_t lo, Double_t up, Double_t tol){ fGauMeanMin = lo; fGauMeanMax = up; fGauMeanTol = tol; }
    ...
    void FitParameters();
    void Fit();
    void Iterate(Int_t n, Bool_t kInit);
